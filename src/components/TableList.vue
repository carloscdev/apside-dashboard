...
<template>
  <Card title="Interacciones" icon="bi-table">
      ...
      <div v-if="props.loading" class="flex justify-center items-center h-64 mx-auto">
        <div>
            <svg aria-hidden="true" class="size-20 text-gray-200 animate-spin fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
